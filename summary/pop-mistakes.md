...
Многие вещи в браузере могут работать по-разному с локальным файлом, локальным сервером ([live server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer), [xampp](https://www.apachefriends.org/ru/index.html) и т.п.) и реальным сервером.
