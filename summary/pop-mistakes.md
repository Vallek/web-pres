...
Часто источник ошибок - устаревшая информация в интернете (посмотрите лекцию про [Поиск информации](https://vallek.github.io/pages/projects/search.html)). Существуют устаревшие элементы и атрибуты, которые согласно современным спецификациям больше нельзя использовать.
