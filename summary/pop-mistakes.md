...
Часто источник ошибок - устаревшая информация в интернете (посмотрите лекцию про [Поиск информации](https://youtu.be/0v7pdd4za6s)). Например, существуют устаревшие элементы и атрибуты, которые согласно современным спецификациям больше нельзя использовать.
