...
Подскажут ошибки: 
* Валидация
* Девтулзы (предупреждения и перечеркивания)
* Встроенная валидация css в vs code
* [Линтеры](https://vallek.github.io/web-links/#linters) - расширения в vs code для поиска ошибок (html, css и js)
