...
В начале пару слов о том, про что эта лекция и чем она может быть вам полезна.
...
Обмен и поиск информации - основа Интернета и веб. Сложно себе представить работу в разработке без использования веба. То же самое можно сказать про процесс образования. Обмен знаниями - основа обучения. При этом без самостоятельного поиска информации не может быть качественного обучения. Почему?
...
Не стоит вообще читать там про что-то связанное с разработкой. 
