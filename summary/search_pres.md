...
При этом относитесь критически к любой информации. В том числе к этой:) Критически — значит сравнивать разные источники. В том числе среди разных типов (спеки, энциклопедии, авторские, ответы на вопросы). А также проверять всё на практике. Лучшее, что можно сделать с новой инфой - открыть редактор кода и попробовать воспроизвести рецепт, который вы прочитали. 
...
Html5css.ru, coderoad.ru и многие другие.

В сети есть много некачественных сайтов, созданных для SEO, копирующих чужой контент, с плохим переводом или сгенерированные "AI".
...
Многие IT компании ведут блоги с полезными статьями. Некоторые из них достаточно качественные, некоторые не очень. Часто написаны не экспертами копирайтерами, не понимающими, о чем они пишут. 
...
Поисковики, какими бы совершенными и "умными" они не были, так или иначе ищут по существующему контенту. И если вы хотите найти текст написанный реальными людьми, стоит подумать, как именно они могли его сформулировать. Это не просто, но приходит с практикой. Это особенно актуально в эпоху контента, сгенерированного "ai".

Вы можете добавлять к поисковому запросу популярные платформы, на которых больше вероятность найти ответ. Например, "reddit", "stackoverflow" и т.п.
...
* [Еще один архив, в котором страницы сохраняют вручную](https://archive.today/)

Но даже с сайтами, которые сохраняют веб, может что-то случиться (гугл закрывает кэш, юзеры удаляют свои комменты с реддита, копирайтеры удаляют книги с веб архива).

Сохраняйте знания локально в базе знаний. Для ее создания можно использовать приложения с заметками, CMS или специальные программы. Можете попробовать [Joplin](https://joplinapp.org/).
