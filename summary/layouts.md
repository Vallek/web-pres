...
Веб продолжает меняться, появляются новые технологии и подходы к дизайну и разработке. Поэтому верстальщикам и фронтендерам стоит всегда следить за обновлениями в этой сфере. 