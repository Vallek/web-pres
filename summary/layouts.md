...
Развитие веб-дизайна прошло через множество этапов. В какой-то момент сформировался традиционный шаблон holy grail. Это дизайн с шапкой, основным содержимым, занимающим большую часть ширины, сайдбаром или двумя и подвалом.
...
При всех своих плюсах обладает и "минусами" при создании сложных раскладок. Суть флексбокса - все элементы располагаются по основной оси. То есть это "одномерная" раскладка. У нее есть направление. И хотя вы можете выравнивать элементы по доп. оси. флексбокс не позволяет создать сложный двухмерный дизайн без огромного количества доп. оберток.
...
### Гриды
Самая современная раскладка. Была создана специально для создания сложного двухмерного дизайна. Можно сказать, что это таблицы только специально созданные для верстки основных блоков интерфейсов. 

Позволяет разделить все на строки и колонки. Но при этом возможна полная адаптивность, произвольное изменение расположения секций по сетке и многое другое.
...
### Будущее веба
На holy grail развитие дизайна, конечно, не остановилось. Следующим популярным дизайном стал "бутерброд" из секций-этажей. Вы до сих пор можете найти множество макетов с таким дизайном в сети.
