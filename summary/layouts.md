...
### Позиционирование
Еще одна вещь, которую часть используют не по назначению для раскладок - позиционирование. То есть значения свойства position. Особенно это касается position: absolute, то есть абсолютного позиционирования.
...
При всех своих плюсах обладает не идеален для создания сложных раскладок. Суть флексбокса - все элементы располагаются по основной оси. То есть это "одномерная" раскладка. У нее есть направление. И хотя вы можете выравнивать элементы по доп. оси. флексбокс не позволяет создать сложный двухмерный дизайн без огромного количества доп. оберток.
...
Позволяет разделить все на строки и колонки. Но при этом возможна полная адаптивность, динамическое изменение расположения секций по сетке и многое другое.
